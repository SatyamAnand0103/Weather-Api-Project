//to display the kocal time with date and name of week day.
let weekday = [
  "Sunday",
  "Monday",
  "Tuesday",
...
function setvaluefor1() {
  document.getElementById("myText").value = "Bokaro Steel City";
...
//     document.querySelector(".main-search-button").click();
//   }
// });

// a function to display all the contents on related to weather .
function showDetails() {
  ...
  for (let i = 0; i < arr.length; i++) {
    document.querySelector(arr[i]).style.visibility = "visible";
  }
}

// a function to hide all the contents of the weather .
...
function hideDetails() {
  ...
  for (let i = 0; i < arr.length; i++) {
    document.querySelector(arr[i]).style.visibility = "hidden";
  }
}
...
function fetchWeatherDetails(cityName) {
  ...
  //setTimeout(() => {
  // //create box for temperature gif
  // let createbox = document.createElement("div");
  // createbox.className = "thermometer";
    ...
    .then((data) => {
      ...
      if (data.cod !== 200) {
        ...
        switch (a) {
          ...
          case "haze":
            b.style.backgroundImage = "url('images/haze.webp')";
            break;
